...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="w-12 h-12 bg-accent-main rounded-full flex items-center justify-center mb-4">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="text-center">
              <div className="w-32 h-32 bg-accent-light/20 rounded-full mx-auto mb-4 flex items-center justify-center">
                <svg className="w-16 h-16 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Dr. Sarah Mitchell</h3>
              <p className="text-accent-main font-medium mb-3">MD, Acupuncturist, Herbalist</p>
              <p className="text-gray-700">
            ...
            <div className="text-center">
              ...
              <p className="text-accent-main font-medium mb-3">Licensed Acupuncturist</p>
              <p className="text-gray-700">
      ...
      {/* Why Choose Us */}
      <section className="bg-gradient-to-br from-accent-light/10 via-white to-secondary-light/10 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={idx} className="flex items-start">
                <svg className="w-6 h-6 text-accent-main mr-4 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
      ...
      {/* CTA Section */}
      <section className="bg-accent-main text-white py-16">
        <div className="max-w-2xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <Link
                href="/booking"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-accent-main font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-200"
            >
                Book an Appointment
            </Link>
        </div>
